...
all: pcclient_to_cel systemd_to_cel systemd_log_to_cel ima-ng_to_cel cel_verify cel_fix_seq
...
cel_verify: cel_verify.c pcclient_verify.c cel.h cel_verify.h pcclient.h pcclient_verify.h ima_template_verify.h ima_template_verify.c
	gcc -Wall -g -o cel_verify cel_verify.c pcclient_verify.c ima_template_verify.c -lssl -lcrypto
